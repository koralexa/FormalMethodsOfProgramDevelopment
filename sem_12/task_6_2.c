...
// gcc -Wall -fsanitize=address,undefined task_6_2.c queue.c -o test_queue
// ./test_queue
// анализ средствами С, запуск

// gcc -Wall -fsanitize=undefined task_6_2.c queue.c -o test_queue
// valgrind ./test_queue
// анализ средствами С, запуск

// scan-build make task_6_2
// проанализировать clang'ом

// scan-view <что-то там>
// открыть красивый анализ с ошибками (последняя строчка в терминале после scan-build make task_6_2)